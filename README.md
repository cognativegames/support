...
|----------|-------------|
| Critical (app crashes, data loss) | Within 24 hours |
| High (feature broken) | Within 48 hours |
| Normal (minor bug, question) | Within 5 business days |
| Low (feature request, feedback) | Reviewed periodically |

We don't guarantee every feature request will be implemented, but all submissions are read and considered.
